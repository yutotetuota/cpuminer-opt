...
} lyra2vc0ban_ctx_holder;

static lyra2vc0ban_ctx_holder lyra2vc0ban_ctx;
static __thread sph_blake256_context l2vc0ban_blake_mid;
...
void l2vc0ban_blake256_midstate( const void* input )
{
    memcpy( &l2vc0ban_blake_mid, &lyra2vc0ban_ctx.blake, sizeof l2vc0ban_blake_mid );
    sph_blake256( &l2vc0ban_blake_mid, input, 64 );
}

void lyra2revc0ban_hash( void *state, const void *input )
{
        lyra2vc0ban_ctx_holder ctx __attribute__ ((aligned (64))); 
        memcpy( &ctx, &lyra2vc0ban_ctx, sizeof(lyra2vc0ban_ctx) );
        ...
        memcpy( &ctx.blake, &l2vc0ban_blake_mid, sizeof l2vc0ban_blake_mid );
	...
	LYRA2REVc0ban( l2vc0ban_wholeMatrix, hashA, 32, hashA, 32, hashA, 32, 1, 4, 4 );
...
int scanhash_lyra2revc0ban(int thr_id, struct work *work,
	uint32_t max_nonce, uint64_t *hashes_done)
{
	...
	if (opt_benchmark)
        ...
        l2vc0ban_blake256_midstate( endiandata );

	do {
		be32enc(&endiandata[19], nonce);
		lyra2revc0ban_hash(hash, endiandata);
